...
\begin{description}
\item [IsType(VakGroep,VakGroepType)] Zoals 
...
/*INSERT EXAMPLE CODE*/
Het vocabularium voor T' is dan ook gelijk dat van T met de toevoeging van het predicaat Regel(Nummer), de interpretatie hiervoor is op voorhand gegeven door het systeem en is altijd true. 
/*REVIEW PROCESS*/